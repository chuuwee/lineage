...
def report_to_discord(name, date, dkp, id, debug):
  ...
  pilot_list = sorted(['{} ({})'.format(pilot.get('pilot'), pilot.get('bot')) for pilot in pilots])
  absentee_list = sorted([discord_format_absentee(absentee) for absentee in absentees])
  ...
  embed.add_embed_field(
    name=" ",
    value="Generated by [DKP script v0.0.9](https://github.com/chuuwee/lineage).",
    inline=False
  )
